...
if (args.data['branchID'] ==="Port Lavaca, TX 77979") { 
  ...
  return (
    ...
    <div className="m-2 md:m-10 mt-24 p-2 md:p-10 bg-hero-water rounded-3xl">
      <Header category="Page" title="Equipments" />
      <GridComponent
        ref={g => grid = g}
      ...
      <Dialog open={open}  onClose={handleToClose}>
        <DialogTitle>{"Details of: "+equip.name}</DialogTitle>
        <DialogContent className='w-full'>
        <div style={{ height: "auto", margin: "0 auto", maxWidth: 200, width: "100%" }}>
        <QRCode
            size={200}
            style={{ height: "auto", maxWidth: "100%", width: "100%" }}
            value={"https://tier1integrity.pocsofclients.com/EquipProfile?id="+equip._id}
            viewBox={`0 0 256 256`}
            logoWidth={180 * 0.2}
        ...
        <div className='h-3'>
          ...
          <DialogContentText className='center'>
            {"Name: "+equip.name}
            <br/>
            {"Available: "+equip.availableQnt}
            <br/>
            {"Dispatched: "+equip.dispatchQnt}
            <br/>
            {"Cost Center: "+equip.branchID}
